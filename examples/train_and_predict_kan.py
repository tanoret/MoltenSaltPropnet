...
BASE_OUTDIR = os.path.join("data", "kan_compare")
...
# ============================================================
print("\n==============================")
print("TRAIN A: WITHOUT element features (KAN)")
print("==============================")
trainerA.train_base()
trainerA.train_meta()
trainerA.evaluate("val")
trainerA.evaluate("test")

print("\n==============================")
print("TRAIN B: WITH element features (KAN)")
print("==============================")
trainerB.train_base()
trainerB.train_meta()
trainerB.evaluate("val")
...
for el in ELEMENT_FILTERS:
    ...
    prefix = f"{el}_test"
    plot_coeffs_A_vs_B(trainerA, trainerB, idxs, title, PLOT_DIR, prefix, MAX_TARGETS_PER_FIG)
    plot_derived_A_vs_B(trainerA, trainerB, idxs, title, PLOT_DIR, f"{el}_derived_A_vs_B_T{int(TEMPERATURE)}K.png", TEMPERATURE)
