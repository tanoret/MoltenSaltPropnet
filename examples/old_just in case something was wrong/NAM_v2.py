...
The CSV already contains a "Composition" column which is a dict
of element fractions (e.g. {'Na':0.5, 'Cl':0.5}). These are
expanded into one column per element and used as inputs.
