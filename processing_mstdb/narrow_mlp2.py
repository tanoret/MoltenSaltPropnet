...
def predict_properties_at_T(processor: MSTDBProcessor, trained: dict, T: float):
    ...
    For each row in processor.df:
      - take ML predictions for all targets in ALL_TARGET_COLS
      - copy cp_c, cp_d from data row if they exist (else 0)
...
if __name__ == "__main__":
    ...
    print("\nPer-target validation metrics (ALL targets):")
